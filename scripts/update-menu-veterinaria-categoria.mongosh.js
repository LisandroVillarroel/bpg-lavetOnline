const menuId = ObjectId('69d84e67a3274a7d6177c1d9');

const menuVeterinariaActualizado = {
  nombreMenu: 'Veterinaria',
  menuItem: [
    {
...
const resultado = db.getCollection('menus').updateOne(
  ...
  {
    $set: {
      nombreMenu: menuVeterinariaActualizado.nombreMenu,
      menuItem: menuVeterinariaActualizado.menuItem,
      estado: 'Activo',
